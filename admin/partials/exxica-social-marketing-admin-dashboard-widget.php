...
<table class="esm-dash-block">
	<tbody>
		<tr><td colspan="2"><?php _e('Do you need help using this plugin?', $this->name); ?><a href="http://exxica.com/using-exxica-social-marketing" target="_blank"><?php _e('Click here', $this->name); ?></a></td></tr>
